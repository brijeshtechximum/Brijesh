...
class Form1 extends CI_Controller {
	...
	public function process_state_sector_form(){
		...
		$config = 	array(
							array(
									'field' => 'state_sector[borrower_name]',
                            ...
                            array(
									'field' => 'state_sector[sector]',
									'label' => 'Sector',
									'rules' => 'trim|required|max_length[20]|alpha',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
										)
                            ...
                            array(
									'field' => 'state_sector[sector]',
									'label' => 'Name of State',
									'rules' => 'trim|required|max_length[35]|alpha',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
										)
                            ...
                            array(
									'field' => 'state_sector[project_name]',
                            ...
                            array(
                             ...
                             array(
									'field' => 'state_sector[category_si]',
									'label' => 'Given',
							...
							array(
									'field' => 'state_sector[category_other]',
									'label' => 'Given',
            	           ...
            	           array(
									...
									'field' => 'state_sector_a[cost_excluding_idc]',
									'label' => 'Project Cost excluding(IDC)',
                            ...
                            array(
									...
									'field' => 'state_sector_a[debt_equity_ratio]',
                            ...
                            array(
									...
									'field' => 'state_sector_a[loan_amount_req_from_rec]',
									'label' => 'Loan Amount requested from REC',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                             ...
                             array(
									...
									'field' => 'state_sector_a[loan_amount_req_other_lenders]',
									'label' => 'Loan Amount requested from Other lenders',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                            ...
                            array(
									'field' => 'state_sector_a[hard_cost]',
									'label' => 'Hard Cost',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                             ...
                             array(
									'field' => 'state_sector_a[soft_cost]',
									'label' => 'Soft Cost',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                              ...
                              array(
									'field' => 'state_sector_b[scope_of_work]',
									'label' => 'Scope of Work ',
                               ...
                               array(
									'field' => 'state_sector_b[project_area]',
									'label' => 'Basis of Cost Estimates',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                              ...
                              array(
									'field' => 'state_sector_b[dpr_preparation]',
									'label' => 'DPR Attachment',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                                ...
                                array(
									'field' => 'state_sector_b[detail_project_justification]',
                              ...
                              array(
									'field' => 'state_sector_b[single_line_project_diagram]',
                              ...
                              array(
									'field' => 'state_sector_b[grid_map_of_proposed_proj]',
									'label' => 'Grid Map',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                              ...
                              array(
									'field' => 'state_sector_b[execution_mode]',
                              ...
                              array(
									'field' => 'state_sector_b[tendering_status]',
									'label' => 'Status of Tendering',
									'rules' => 'trim|max_length[30]|alpha_numeric_spaces',
									
							    ), 
                            
            
                              array(
									'field' => 'state_sector_b[irr]',
									'label' => 'IRR',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                            ...
                            array(
									...
									'field' => 'state_sector_b[board_of_directors]',
                            ...
                            array(
									'field' => 'state_sector_b[proj_implementation_period]',
                        ...
                        /*
                              array(
									'field' => 'state_sector_b[land_acquisitions_status]',
									'label' => 'Status of Land Acquisitions',
									'rules' => 'trim|max_length[20]|alpha',
									'errors' => array(
                            ...
                            */
                             ...
                             array(
									'field' => 'state_sector_b[security_provided_for_loan]',
									'label' => 'Security to be provided',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                            ...
                            array(
									'field' => 'state_sector_b[escrow_cover_availability]',
									'label' => 'Availablity of Escrow cover',
									'rules' => 'trim|required|max_length[20]|alpha',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                            ...
                            array(
									'field' => 'state_sector_b[loan_repayment_period_req]',
                            ...
                            array(
									'field' => 'state_sector_b[moratorium]',
                            ...
                            array(
									'field' => 'state_sector_b[clearance_req]',
									'label' => 'Clearances',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                            ...
                            array(
									'field' => 'state_sector_b[sanction_letter_of_agency]',
									'label' => 'Sanction letter of Agency',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                            ...
                            array(
									'field' => 'state_sector_c[power_position]',
									'label' => 'Brief',
									'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                        ...
                        /*
                            array(
									'field' => 'state_sector_c[audit_ac_status]',
									'label' => 'Status of Audited Accounts',
                        ...
                        */
                            ...
                            array(
									...
									'field' => 'state_sector_c[total_revenue]',
									'label' => 'Total Revenue',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                              ...
                              array(
									...
									'field' => 'state_sector_c[total_expenditure]',
                             ...
                             array(
									...
									'field' => 'state_sector_c[profit_after_tax]',
                        ...
                        /*
                            array(
									...
									'field' => 'state_sector_c[tariff_petition]',
									'label' => 'Tariff Petition',
                        ...
                        */
                                ...
                                array(
									...
									'field' => 'state_sector_c[tarriff_order]',
									'label' => 'Tariff Order',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                            ...
                            array(
									...
									'field' => 'state_sector_c[regulatory_assets_approved]',
									'label' => 'Regulatory Assets Approved(',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                        ...
                        array(
									...
									'field' => 'state_sector_c[fy1]',
									'label' => 'FY (2017-18)',
									'rules' => 'trim|required|max_length[10]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
										)
                        ...
                        array(
									...
									'field' => 'state_sector_c[default_status]',
                        ...
                        array(
									...
									'field' => 'state_sector_c[entity_grade]',
									'label' => 'Entity Grade of Borrower',
                        ...
                        array(
									...
									'field' => 'state_sector_c[rec_exposure]',
									'label' => 'Exposure to REC',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
                        ...
                        array(
									...
									'field' => 'state_sector_c[relaxations]',
									'label' => 'Relaxations',
									'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
                        ...
                        array(
									...
									'field' => 'state_sector_c[chkUtility]',
									'label' => 'MOUs signed with Utility',
                          ...
                          array(
									...
									'field' => 'state_sector_c[chkappUtility]',
									'label' => 'Administrative Approval of Utility',
									'rules' => 'trim|max_length[5]|alpha',
									'errors' => array(
		...
		redirect(base_url()."form1/index/statesectorthings/step2"); 
            ...
            redirect(base_url()."form1/index/statesectorthings/step1");   
	...
	public function process_generation_a()
	{
		...
		$config = 	array(
					...
					array(
							...
							'rules' => 'trim|max_length[3]|alpha_numeric_spaces',
							'errors' => array(
					...
					array(
							'field' => 'gn_b1[address][]',
							'label' => 'Address',
							'rules' => 'trim|max_length[12]|alpha_numeric_spaces',
							'errors' => array(
	...
	//processing step 2 form generation
		...
		if($this->input->method(true)=="POST"){
			...
			$config = 	array(
					array(
							'field' => 'phase1_project_details[name_of_lead_bank]',
							'label' => 'Name of the Lead Bank',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[name_of_bank_FI][]',
							'label' => 'Name of Bank/FI',
							'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[name_of_bank_amount][]',
							'label' => 'Amount',
				...
				/*	array( 3) sanction details (status) radio button 
							'field' => 'phase1_project_details[name_of_bank_amount][]',
							'label' => 'Amount',
							'rules' => 'trim|required|max_length[9]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
								)
					...
					array(
							'field' => 'phase1_project_details[cost_comparison_bench_marking]',
					...
					array(
							'field' => 'phase1_project_details[prepare_by_whom]',
							'label' => 'DPR (Name of the consultant) ',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[dpr_year]',
							'label' => 'DPR year ',
							'rules' => 'trim|required|max_length[9]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
					...
					array(
							'field' => 'phase1_project_details[name_of_statutory_auditors]',
							'label' => 'Name of the Statutory Auditors ',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[information_memorandum_financial_mode]]',
							'label' => 'DPR/Information Memorandum with Financial Model',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
				...
				array( 
							'field' => 'phase1_project_details[date_of_ppa][]',
							'label' => 'Date of PPA',
							'rules' => 'trim|required|max_length[12]|callback_SCOD',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
					...
					array(
							'field' => 'phase1_project_details[utility_discom][]',
					...
					array(  
							'field' => 'phase1_project_details[ppa_capacity][]',
							'label' => 'Capacity',
							'rules' => 'trim|required|max_length[9]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
					...
					array(
							'field' => 'phase1_project_details[ppa_tariff][]',
							'label' => 'Tariff',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
					...
					array(
							'field' => 'phase1_project_details[ppa_mou_case_1][]',
							'label' => 'MoU/Case-I',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
					...
					array(  
							'field' => 'project_details1[yet_tied_capacity][]',
							'label' => 'Capacity',
							'rules' => 'trim|required|max_length[9]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
					...
					array(
							'field' => 'project_details1[yet_tied_proposed_through][]',
							'label' => 'Proposed through',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'project_details1[yet_tied_expected_tariff][]',
					...
					array(
							'field' => 'project_details1[yet_tied_detail_bidding_participated][]',
							'label' => 'Details of bidding participated',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[plant_technology_capacity]',
					...
					array(
							'field' => 'phase1_project_details[infrastructure_land_requirement]',
							'label' => 'Infrastructure(Land Requirement, Availability and type of land ',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[water_estimated_requirement_source]',
							'label' => 'Water(estimated requirement, source and plan to meet the water requirement)',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[fuel_estimated_requirement_source]',
							'label' => ' Fuel(estimated requirement, source and plan',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[project_plant_implementation_schedule]',
							'label' => 'Project Plant & Implementation Schedule',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[pan_for_power_evacuation_infrastructure_existing]',
							'label' => 'Plan for Power Evacuatio',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[power_sale_offtake_banking]',
							'label' => 'Power Sales & Offtake',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[licenses_approval_pollution_clearance]',
					...
					array(
							'field' => 'phase1_project_details[licenses_approval_water_allocation]',
					...
					array(
							'field' => 'phase1_project_details[licenses_approval_environment_clearance]',
					...
					array(
							'field' => 'phase1_project_details[licenses_approval_forest_land_clearance]',
							'label' => 'Forest Land clearance (Project site)',
							'rules' => 'trim|required|max_length[5]|alpha',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[licenses_approval_forest_land_evacuation]',
							'label' => 'Forest Land clearance (Evacuation)',
							'rules' => 'trim|required|max_length[5]|alpha',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[licenses_approval_civil_aviation_clearance]',
							'label' => 'Civil aviation clearance (chimney height)',
							'rules' => 'trim|required|max_length[5]|alpha',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'phase1_project_details[PPA]',
							'label' => 'PPA',
							'rules' => 'trim|required|max_length[5]|alpha',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
		...
		$config = 	array(
			...
			*/
			...
			$gn_3 = array(
				...
				'cmmitments'=>$this->input->post('phase1_loc_lan_wat')['cmmitments'],
	...
	public function process_generation_4(){
		...
		if($this->input->method(true)=="POST"){
			...
			$config = 	array(
					array(
							'field' => 'contract_project1',
							'label' => 'Contracting & Project',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'contract_epc_route',
							'label' => 'Please provide the details of the current status',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'contract_contractor_past_record',
							'label' => 'Experience and past track record',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'contract_num_of_plants',
							'label' => 'How many plants of the similar technology',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'contract_installations_india',
							'label' => 'List of all the installations',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'contract_installations_abroad',
							'label' => 'List of all the installations other countries',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'contract_past_project_implemeted_time_cost',
							'label' => 'Whether the past projects',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'contract_years_in_business_tunover_employees',
							'label' => 'Number of years in business employees',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'contract_years_in_business',
					...
					array(
							'field' => 'contract_epc_contractor_group_company',
							'label' => 'Whether the EPC Contractor',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'project_management_team_member[]',
							'label' => 'Team Member',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
					...
					array(
							'field' => 'owners_engineer',
							'label' => 'Owners Engineer',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'copies_of_licenses',
							'label' => 'Copies of Licenses',
					...
					array(
							'field' => 'project_allotment_letter',
							'label' => 'Project Allotment Letter',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
					...
					array(
							'field' => 'hydrology_studies',
							'label' => 'Hydrology Studies',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
					...
					array(
							'field' => 'land_search_report',
							'label' => 'Land search report showing chain',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
					...
					array(
							'field' => 'mutation_of_all_transaction',
							'label' => 'Mutation of all transaction',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
					...
					array(
							'field' => 'proof_of_acquisition_land',
							'label' => 'Proof of acquisition of land',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
					...
					array(
							'field' => 'letter_allocation_allotment_assurance_fuel_water',
					...
					array(
							'field' => 'copies_fuel_supply_agreement_case',
							'label' => 'Copies of fuel supply agreement in case of Biomass',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
					...
					array(
							'field' => 'copies_of_major_contracts',
							'label' => 'Copies of the major Contracts',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
					...
					array(
							'field' => 'project_layout_diagram',
							'label' => 'Project Layout Diagram',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
					...
					array(
							'field' => 'contractor_for_main_plant_bop',
							'label' => 'Contractors',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
					...
					array(
							'field' => 'supplier_main_plant_machine_btg_package',
							'label' => 'Suppliers of Main Plant & Machinery',
							'rules' => 'trim|required|max_length[3]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} invalid input',
			...
			$config = 	array(
					array(
							...
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
									'alpha_numeric_spaces' => '{field} invalid input',
								)
					),
					array(
							'field' => 'date',
	...
	public function process_rn_1(){
		...
		$config = 	array(
					...
					array(
							'field' => 'project_type',
							'label' => 'Project Type',
							'rules' => 'trim|required|max_length[18]|alpha',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
								)
					...
					array(
							'field' => 'location',
							'label' => 'Location including Village Tehsil District State',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'powersale1',
							'label' => 'Power Sale Arrangement',
							'rules' => 'trim|required|max_length[15]|alpha',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
								)
					...
					array(
							'field' => 'cost_without_roe',
							'label' => 'Levellised cost of generation',
							'rules' => 'trim|required|max_length[15]|numeric',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'awarding_project',
							'label' => 'Awarding of project',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
						...
						array(
							'field' => 'directors[]',
							'label' => 'Name of Directors of the Borrower',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
	...
	$this->form_validation->set_rules($config);
		...
		redirect(base_url()."form1/index/rn/renew2");
				...
				$error = $this->form_validation->error_array();
				$this->session->set_flashdata('step1', $error);
				redirect(base_url()."form1/index/rn/renew1");
			}
	...
	public function process_rn_2(){
		...
		$this->form_validation->set_error_delimiters('<div class="has-error"><span class="help-block">', '</span></div>');
			$config = 	array(
					array(
							'field' => 'lead_bank',
							'label' => 'Name of the Lead Bank/Financial Institution',
					...
					array(
							'field' => 'info_memo_fin',
							'label' => 'Information Memorandum with Financial Model of Lead Bank/FI',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'ppa_date',
							'label' => 'Date of PPA',
							'rules' => 'trim|required|max_length[50]|callback_SCOD',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
								)
					...
					array(
							'field' => 'cr_ratng_pwr_prchse',
							'label' => 'Credit rating of Power Purchaser',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'pmnt_secrty',
							'label' => 'Payment security mechanism',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'lvel_gen_cost',
							'label' => 'Levelized Cost of Generation',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'prj_irr_post_tax',
							'label' => 'Project IRR Post',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'prj_irr_pre_tax',
							'label' => 'Project IRR PreTax',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'finance_model',
							'label' => 'Financial model in form of excel sheet',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'evacuation_label',
							'label' => 'Evacuation at which label',
							'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'nearst_forest',
							'label' => 'Nearest Forest/ lake or any natural bodies',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'nrst_rail',
							'label' => 'Nearest Railway Station/ Distance',
							'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
	...
	public function process_rn_3(){
		...
		$config = 	array(
					array(
							'field' => 'curnt_user_of_land',
							'label' => 'Classification/Current Use of land and ownership',
					...
					array(
							'field' => 'land_req_per_dpr',
							'label' => 'Land Required for the entire plant as per DPR',
							'rules' => 'trim|required|max_length[500]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'land_req_main_plant',
							'label' => 'Land Required for Main Plant',
							'rules' => 'trim|required|max_length[500]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'domestc_coal_gas_capacity',
							'label' => 'GCV',
							'rules' => 'trim|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
					...
					array(
							'field' => 'plan_mett_fuel_req_plant',
					...
					array(
							'field' => 'anul_contrct_qty',
							'label' => 'Annual contracted quantity',
							'rules' => 'trim|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
					...
					array(
							'field' => 'loa_date',
							'label' => 'LOA Date',
							'rules' => 'trim|required|max_length[100]|callback_SCOD',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
								)
					...
					array(
							'field' => 'num_fmly_rehbltn',
							'label' => 'No of families need to be resettled/rehabilitated',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'steps_flora_fauna',
							'label' => 'Steps required for protection of flora and fauna',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'steps_forests_wildlife',
							'label' => 'Steps required for protection of forests and wildlife',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'archlogical_monumnts',
							'label' => 'Is there any submergence of any religious or archaeological monuments',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'issue_pretng_hvy_eqpmnt',
							'label' => 'Issues pertaining to movement of heavy equipment/machinery to site',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
									'max_length'     => '{field} must have at least {param} characters.',
					...
					array(
							'field' => 'num_yr_for_whch_data_avail',
							'label' => 'No of years for which data available',
							'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
							'errors' => array(
									'required' 		=> '{field} must not be empty.',
	...
	public function process_rn_4(){
		...
		$this->form_validation->set_error_delimiters('<div class="has-error"><span class="help-block">', '</span></div>');
			$config = 	array(
					...
					array(
							'field' => 'chkAvailability',
							'label' => ' per year water availability',
							'rules' => 'trim|max_length[5]|alpha',
							'errors' => array(
									'alpha' => 	'{field} Enter a valid Input',
									'max_length'     => '{field} must have at least {param} characters.',
								)
					),
					array(
							'field' => 'chkAvailability_yes',
							'label' => 'Other',
							'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
					...
					array(
							'field' => 'lat',
							'label' => 'GPS coordinates of upstream water head Latitude',
							'rules' => 'trim|max_length[50]|decimal',
							'errors' => array(
					...
					array(
							...
							'rules' => 'trim|max_length[50]|decimal',
							'errors' => array(
									'decimal'	=>	'{field} Enter a valid input',
									'max_length'     => '{field} must have at least {param} characters.',
								)
					),
					array(
					...
					array(
							'field' => 'est_pwr_gen_capacity_avail',
							'label' => 'Estimated power generation capacity available',
							'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
					...
					array(
							'field' => 'land_for_enrgy_plant_ha',
							'label' => 'Land available for energy plantations',
							'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
					...
					array(
							'field' => 'num_sunny_days_per_yr',
							'label' => 'Number of sunny days available per year',
							'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
					...
					array(
							'field' => 'num_days_wind_pwr_per_yr1',
							'label' => 'days available for wind power generation',
							'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
					...
					array(
							'field' => 'wind',
							'label' => 'Availability of land for wind farm',
							'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
							'errors' => array(
		...
		$chk_data = $this->WM->check_rn5_exist($user_id);
			...
			$this->form_validation->set_error_delimiters('<div class="has-error"><span class="help-block">', '</span></div>');
				$config = 	array(
						array(
								'field' => 'cntrct_prj_dvlpmnt',
								'label' => 'Contracting & Project Development',
								'rules' => 'trim|required|max_length[500]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'crnt_status_epc_cntcts',
								'label' => 'Please provide the details of the current status of the EPC contacts',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'exp_past_track_record_cntrct',
								'label' => 'Experience and past track record of the Contractor',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'num_plants_same_tech',
								'label' => 'How many plants of the similar technology and size did the Contractor implement',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'list_all_inst_implmnt_india',
								'label' => 'List of all the installations/implementations in India',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'list_all_inst_implmnt_abroad',
								'label' => 'List of all the installations/implementations in other countries',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'past_prj_imlmnt_on_time',
								'label' => 'Whether the past projects were implemented in time and costs',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'num_yr_busns_of_epc',
								'label' => 'Number of years in business, Turnover of the EPC Contractor and number of employees',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'epc_group_comp',
								'label' => 'Whether the EPC Contractor is a group company',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'company_name_om_contract',
								'label' => 'Name of company with whom O&M contract is signed',
								'rules' => 'trim|required|max_length[100]|alpha_numeric_spaces',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'Doc4',
								'label' => 'Feasibility Report, Cost Estimates ',
								'rules' => 'trim|required|max_length[5]|alpha',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
						...
						array(
								'field' => 'Doc6',
								'label' => 'Land search report showing chain of transaction',
								'rules' => 'trim|required|max_length[5]|alpha',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
			...
			$this->form_validation->set_error_delimiters('<div class="has-error"><span class="help-block">', '</span></div>');
				$config = 	array(
						...
						array(
								...
								'rules' => 'trim|required|max_length[7]|alpha',
								'errors' => array(
										'required' 		=> '{field} must not be empty.',
										'max_length'     => '{field} must have at least {param} characters.',
									)
	...
	public function process_ss_generation_a()
	{
		...
		$config = 	array(
							...
							array(
									'field' => 'ss_gn_a[project_type_others]',
									'label' => 'Given',
									'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
							...
							array(
									'field' => 'ss_gn_a[project_capacity]',
									'label' => 'Project Capacity (In Mw)',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
							...
							array(
									'field' => 'ss_gn_a[project_location]',
									'label' => 'Location including Village/ Tehsil/ District/ State',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_a[project_power_sale_arrangement]',
									'label' => 'Power Sale Arrangement',
									'rules' => 'trim|required|max_length[20]|alpha',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_a[project_power_sale_arrangement_other]',
									'label' => 'Remarks',
									'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
							...
							array(
									'field' => 'ss_gn_a[project_cost_without_idc]',
									'label' => 'Project Cost without IDC',
									'rules' => 'trim|required|max_length[9]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_a[project_idc_interest_durin_construction]',
									'label' => 'IDC (Interest During Construction)',
									'rules' => 'trim|required|max_length[9]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
								...
								array(
									'field' => 'ss_gn_a[project_cost_debt]',
									'label' => 'Debt',
									'rules' => 'trim|required|max_length[9]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
								...
								array(
									'field' => 'ss_gn_a[project_cost_equity]',
									'label' => 'Equity',
									'rules' => 'trim|required|max_length[9]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
								...
								array(
									'field' => 'ss_gn_a[project_loan_requested]',
									'label' => 'Loan Requested',
									'rules' => 'trim|required|max_length[9]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
								...
								array(
									'field' => 'loan_out_total_loan[]',
									'label' => 'loan out of total loan',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
							...
							array(
									'field' => 'ss_gn_a[project_construction_period]',
									'label' => 'Construction Period',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_a[project_loan_repayment_period]',
									'label' => 'Loan Repayment Period',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_a[moritorium_period]',
									'label' => 'Moritorium Period',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
							...
							array(
							'field' => 'ss_gn_a[project_scheduled_completion_date]',
							'label' => 'Project Completion date',
							'rules' => 'trim|required|max_length[12]|callback_SCOD',
							'errors' => array(
							...
							array(
								...
								array(
									'field' => 'ss_gn_a[project_levellised_tariff]',
									'label' => 'Levellised Tariff',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_b1[borrower_promoters_name][]',
									'label' => 'Name of The Promoters of Borrower',
									'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
							...
							array(
									'field' => 'ss_gn_b1[shareholding_promoter][]',
									'label' => 'Shareholding of Promoter',
									'rules' => 'trim|max_length[50]|numeric',
									'errors' => array(
							...
							array(
									'field' => 'ss_gn_b[group_company_promoter]',
									'label' => 'Promoters Contribution',
									'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_c[authorized_signatory_project_name]',
									'label' => 'Name',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_c[authorized_signatory_project_address]',
									'label' => 'Address',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_c[authorized_signatory_project_phone]',
									'label' => 'Phone',
									'rules' => 'trim|required|max_length[12]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
								...
								array(
								'field' => 'ss_gn_c[authorized_signatory_project_email]',
								'label' => 'Email',
								'rules' => 'trim|valid_email',
								'errors' => array(
								...
								array(
									'field' => 'ss_gn_c[authorized_signatory_project_pan]',
									'label' => 'PAN',
									'rules' => 'trim|required|max_length[10]|callback_pan',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_c[authorized_signatory_project_aadhar]',
									'label' => 'Aadhar Number',
									'rules' => 'trim|required|max_length[12]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
								...
								array(
									'field' => 'ss_gn_c[authorized_person_borrower_name]',
									'label' => 'Name',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_c[authorized_person_borrower_address]',
									'label' => 'Address',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_c[authorized_person_borrower_phone]',
									'label' => 'Phone',
									'rules' => 'trim|required|max_length[12]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
								...
								array(
								'field' => 'ss_gn_c[authorized_person_borrower_email]',
								'label' => 'Email',
								'rules' => 'trim|valid_email',
								'errors' => array(
								...
								array(
									'field' => 'ss_gn_c[authorized_person_borrower_pan]',
									'label' => 'PAN',
									'rules' => 'trim|required|max_length[10]|callback_pan',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'ss_gn_c[authorized_person_borrower_adhaar_number]',
									'label' => 'Aadhar Number',
									'rules' => 'trim|required|max_length[12]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
		...
		redirect(base_url()."form1/index/ss_gn/step-2");
			...
			$error = $this->form_validation->error_array();
			$this->session->set_flashdata('step1', $error);
			redirect(base_url()."form1/index/ss_gn/step-1");
		}
	}
...
//print_r($_POST);die;
		...
		$config = 	array(
							...
							array(
									'field' => 'ss_phase1_project_details[name_of_bank_FI][]',
									'label' => 'Name of Bank/FI',
									'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
							...
							array(
									'field' => 'ss_phase1_project_details[name_of_bank_amount][]',
									'label' => 'Amount',
							...
							array(
									'field' => 'phase1_project_details[cost_comparison_bench_marking]',
									'label' => 'Cost Comparison with CERC/SERC',
									'rules' => 'trim|required|max_length[10]|numeric',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
							...
							array(
									'field' => 'phase1_project_details[information_memorandum_financial_mode]',
									'label' => 'DPR/Information Memorandum',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
							...
							/* array(
							'field' => 'project_details[date_of_ppa][]',
							'label' => 'Date of PPA',
							...
							array(
									'field' => 'Utility/Discom',
									'label' => 'project_details[utility_discom][]',
									'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
							...
							array(
									'field' => 'project_details[ppa_capacity][]',
									'label' => 'Capacity',
									'rules' => 'trim|max_length[10]|numeric',
									'errors' => array(
									//		'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'project_details[ppa_tariff][]',
									'label' => 'Tariff',
									'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
							...
							array(
									'field' => 'project_details[ppa_mou_case_1][]',
									'label' => 'MoU/Case-I+9',
									'rules' => 'trim|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
							...
							array(
								...
								array(
									'field' => 'phase1_project_details[remarks]',
									'label' => 'Remarks',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'phase1_project_details[infrastructure_land_requirement]',
									'label' => 'Infrastructure(Land Requirement, Availability) ',
									'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
							...
							array(
									'field' => 'phase1_project_details[pan_for_power_evacuation_infrastructure_existing]',
									'label' => 'Plan for Power Evacuation',
									'rules' => 'trim|required|max_length[200]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
	...
	public function process_ss_generation_3(){
		...
		$config = 	array(
							...
							array(
									'field' => 'phase1_loc_lan_wat[fuel_domestic_percent]',
									'label' => 'Imported Coal',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'phase1_loc_lan_wat[fuel_imported_percent]',
									'label' => 'Domestic  Coal %',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
							...
							array(
									'field' => 'phase1_loc_lan_wat[fuel_plan_meeting_fuel_requirement]',
									'label' => 'Plan for meeting the fuel',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
							...
							array(
								...
								array(
									'field' => 'phase1_loc_lan_wat[hydro_resettlement]',
									'label' => 'Resettlement & Rehabilitation',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
								...
								array(
									'field' => 'phase1_loc_lan_wat[hydro_archaelogical_monuments]',
									'label' => 'Is there any submergence',
									'rules' => 'trim|required|max_length[50]|alpha_numeric_spaces',
									'errors' => array(
											'required' 		=> '{field} must not be empty.',
											'max_length'     => '{field} must have at least {param} characters.',
	...
	public function process_ss_generation_4()
	{
		...
		$config = 	array(
					...
					array(
							'field' => 'promoter_company',
							'label' => 'Certified Copies of Memorandum',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'audited_balance',
							'label' => 'Audited Balance Sheets',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'undertake_project',
							'label' => 'Board’s resolution to undertake',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'geological_study',
							'label' => 'Geological study',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'machinery',
							'label' => 'Import of equipment/machinery',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'transmission_cost',
							'label' => 'Brief note on estimated transmission',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							...
							'label' => 'Brief note on physical/financial ',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'purchase_agreement',
							'label' => 'Power Purchase Agreement/Wheeling',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'statutory_clearances',
							'label' => 'Copies of statutory and non-statuary',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'land_acquisition',
							'label' => 'Proof of completion of Land',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'mobilization',
							'label' => 'Brief note on promoters contribution ',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'relevent_document',
							'label' => 'Brief note on the security',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'environment_aspects',
							'label' => 'Brief note on environment',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							...
							'label' => 'Brief note on socio-economic',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							'field' => 'applicable_subsidy',
							'label' => 'Brief note on Central/ State Govt. policy',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
					...
					array(
							...
							'label' => 'Brief note on Risks & Management',
							'rules' => 'trim|max_length[5]|numeric',
							'errors' => array(
