    ...
    <div class="container">
	  ...
	  <!------------------------step-1-------------------->
        ...
        <div class="row setup-content" id="step-1">
          ...
          <form class="loan-form" role="form" action="<?php echo base_url(); ?>form2/sectionc1/step-1" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>1.</strong> Can the Core Promoters management be considered to be broad-based?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="core_prmtrs_mngmnt_broad_based_optnl_atchmnt_file" >
                  </span> </div>
              </div>
              <div class="">
                <div class="">
                  ...
                  <div class="form-group col-md-4">
                    <label>v) PAN</label>
                    <input type="text" class="form-control" name="respect_of_directors_pan" value="<?php print($sec_c1['respect_of_directors_pan']); ?>" required>
                  </div>
                  <div class="form-group col-md-4">
                    <label>vi) DIN</label>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>2.</strong> Do the Core Promoters employ qualified, experienced and professional management personnel?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="emply_qulifed_exprnc_mngmnt_optnl_atchmnt_file" >
                  </span> </div>
              </div>
              <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>3.</strong> Do the Core Promoters have generally efficient systems and procedures?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="genraly_eficient_systms_prcedurs_optnl_atchmnt_file" >
                  </span> </div>
              </div>
              <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>4.</strong> Have the Core Promoters demonstrated their ability to satisfactorily complete infrastructure, industrial or other projects in the past?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="dmnstrte_ablty_infrstrutre_indstrl_othr_prjcts_file"  >
                  </span> </div>
              </div>
              <div class="">
                <div class="">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="attach"> <span class="btn btn-primary btn-file"> <span>Attach Statutory Auditor Certificate</span>
                      <input type="file" accept="application/pdf"  name="simlr_dtls_core_prmtrs_statry_audtr_certfcate_file" >
                      </span> </div>
                  </div>
                </div>
              </div>
		...
		<form class="loan-form" role="form" action="<?php echo base_url(); ?>form2/sectionc2/step-2" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>5.</strong> Is the size of the Core Promoters existing operations comparable to their expansion plans?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="core_prmtrs_exstng_oprtions_expnsn_plns_optnl_certfcte_file" >
                  </span> </div>
              </div>
              <div class="">
                <div class="">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>6.</strong> Do the Core Promoters deploy conservative debt gearing levels to pursue their business plans?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="deploy_cnsrvtve_debt_optnl_atchmnt_file">
                  </span> </div>
              </div>
                  <div class=" form-group col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>7.</strong> Are the expansion plans of the Core Promoter reasonable and stable in nature?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="resnble_stble_nature_optnl_atchment_file" >
                  </span> </div>
              </div>
              <div class="">
                <div class="">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>8.</strong> Do the Core Promoters have the policy of hedging foreign currency exposure?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="polcy_hedgng_forgn_curncy_optnl_certfcte_file" >
                  </span> </div>
              </div>
              <div class="">
                <div class="">
		...
		<form class="loan-form" role="form" action="<?php echo base_url(); ?>form2/sectionc3/step-3" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>9.</strong> Do the Core Promoters have any experience in the power sector?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="exprnce_prjct_pwr_sctr_optnl_atchmnt_file" >
                  </span> </div>
              </div>
              <div class="">
                <div class="">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>10.</strong> Have  the  Core  Promoters  developed  /  operated  any  power  project  comparable  to  the proposed project?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="devlped_oprtd_per_cmprble_prpsd_prjct_file" >
                  </span> </div>
              </div>
              <div class="col-md-12">
              <h6>Please provide the following details:</h6>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>11.</strong> Do the Core Promoters have the experience in developing, operating, providing EPC services or manufacturing <br>equipment for power projects?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="exprnce_devlpng_oprtng_epc_srvcs_mnfctriing_file">
                  </span> </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>12.</strong> Do the Core Promoters have power operating capacities comparable to the top domestic players in the relevant space?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="pwr_oprtng_capcties_top_domstc_plyrs_file" >
                  </span> </div>
              </div>
		...
		<form class="loan-form" role="form" action="<?php echo base_url(); ?>form2/sectionc4/step-4" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>13.</strong> Have the Core Promoters developed any project of <u>similar nature</u> in the past?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="core_prmtrs_prjct_simlr_natre_file" >
                  </span> </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>14.</strong> Have the Core Promoters developed or operated any infrastructure project of <u>similar size</u>?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="infrstrcture_prjct_simlr_size_file" >
                  </span> </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>15.</strong> Have the Core Promoters set up or managed any like size industrial project?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="setup__mnged_indstrial_size_prjct_file" >
                  </span> </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>16.</strong> Do  the  Core  Promoter  have  the  experience  in  developing,  operating  or  providing  EPC services for infrastructure or industrial <br>projects of the like size projects?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="providng_epc_srvces_indstrial_or_indstrial_prjcts_file" >
                  </span> </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>17.</strong> Do the Core Promoters have any experience of <u>developing/ managing businesses</u> in India or other developing economies?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="manged_busines_devlpng_ecnomies_file" >
                  </span> </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>18.</strong> Do the Core Promoter have prior experience of dealing with the Government and other regulatory authorities in India?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="prior_expirnce_dlng_gov_authrty_india_file" >
                  </span> </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>19.</strong> Do the Core Promoters have experience of acquiring land and/or obtaining environmental clearances in India?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="acquiring_land_clernce_india_file" >
                  </span> </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>20.</strong> Have the Core Promoters successfully developed/ managed any similar projects in India or other developing economies?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span>Optional Attachment</span>
                  <input type="file" accept="application/pdf"  name="successfully_devlpng_simlr_prjcts_ecnomies_file" >
                  </span> </div>
              </div>
