  ...
  <section class="main-form"> 
      ...
      <div class="loan-form">
        <div class="row setup-content" id="step-1">
          ...
          <div class="form-group col-md-4 col-sm-4">
            ...
            <input type="text" readonly class="form-control" name="promoter_name" required="" value="<?php echo $secb1['promoter_name']?>">
          </div>
          <div class="form-group col-md-4 col-sm-4">
            <label>2) PAN</label>
            <div class="attach">
              <input type="text" readonly class="form-control" name="pan" value="<?php echo $secb1['pan']?>" required>
          ...
          <div class="form-group col-md-4 col-sm-4">
            ...
            <div class="attach">
              <input type="text" readonly class="span2 form-control" id="dp6" placeholder="dd-mm-yyyy" pattern="\d{1,2}/\d{1,2}/\d{4}" name="incorp_date" required=""  value="<?php echo $secb1['incorp_date']?>">
          ...
          <div class="form-group col-md-6 col-sm-6">
            ...
            <div class="attach">
              <input type="text" readonly class="span2 form-control" id="dp7" placeholder="dd-mm-yyyy" pattern="\d{1,2}/\d{1,2}/\d{4}" name="comncmnt_bsns_date" required=""  value="<?php echo $secb1['comncmnt_bsns_date']?>">
          ...
          <div class="form-group col-md-6 col-sm-6">
            ...
            <div class="">
              ...
              <label for="chkNnameb" class="radio-inline">
                ...
                No </label>
              <div class="attach pull-right" id="dvNameb" style="display: <?php if($secb1['namechange_since_incorp']=="No"){echo "none"; }else{ echo "block"; }?>">
          ...
          <div class="form-group col-md-6 col-sm-6">
            ...
            <input type="text" readonly class="form-control" name="reg_ofc_add" required="" value="<?php echo $secb1['reg_ofc_add']?>">
          </div>
          <div class="form-group col-md-6 col-sm-6">
            <label>8) Address for communication</label>
            <input type="text" readonly class="form-control" name="communication_add" required="" value="<?php echo $secb1['communication_add']?>">
          </div>
          <div class="form-group col-md-6 col-sm-6">
            <label>9) Location of main plants</label>
            <input type="text" readonly class="form-control" name="main_plant_loc" required="" value="<?php echo $secb1['main_plant_loc']?>">
          </div>
          <div class="form-group col-md-6 col-sm-6">
            <label>10) Committed Equity amount in the proposed power project</label>
            <input type="number" readonly class="form-control" name="cmtd_eqty_amnt_in_prpsd_pwr_prj" pattern="^\d+(?:\.\d{1,2})?$" step="0.01" required="" value="<?php echo $secb1['cmtd_eqty_amnt_in_prpsd_pwr_prj']?>">
          </div>
          <div class="form-group col-md-6 col-sm-6">
            ...
            <div class="attach">
              <input type="text" readonly class="form-control" name="board_resoltn_invst_comtd_eqty_copy" required="" value="<?php echo $secb1['board_resoltn_invst_comtd_eqty_copy']?>">
          ...
          <div class="form-group col-md-7 col-sm-7">
            ...
            <input type="text" readonly class="form-control" name="instrmnt_to_infuse_eqty" required="" value="<?php echo $secb1['instrmnt_to_infuse_eqty']?>">
          </div>
          <div class="form-group col-md-5 col-sm-5">
            <label>13) Clause in MOA authorizing setting up of power project</label>
            <div class="attach">
              <input type="text" readonly class="form-control" name="claus_moa_authrz_setng_pwr_prj" required="" value="<?php echo $secb1['claus_moa_authrz_setng_pwr_prj']?>">
          ...
          <div class="form-group col-md-6 col-sm-6">
            ...
            <input type="text" readonly class="form-control" name="prmtr_grp" required="" value="<?php echo $secb1['prmtr_grp']?>">
			</div>
          <div class="form-group col-md-6 col-sm-6">
            <label>15) Peer Companies within the same industry</label>
            <input type="text" readonly class="form-control" name="peer_comp_for_same_indstry" required="" value="<?php echo $secb1['peer_comp_for_same_indstry']?>">
          </div>
        ...
        <div class="row setup-content" id="step-2">
            ...
            <div class="sub-part">
             ...
             <div id="dvRel" class="previousrelation" style="display: <?php if($secb2['chkPrevious']=="yes" || $secb2['chkPrevious'] == "" ){echo "block" ;}else{echo "none"; }?>">
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                      ...
                      <input type="text" readonly name="prjct_name" class="form-control dvRelinput" value="<?php echo $secb2{'prjct_name'}?>" >
                    </div>
                    <div class="form-group col-md-6 col-sm-6">
                      <label>b) Type of Project</label>
                      <input type="text" readonly name="prjct_typ" class="form-control dvRelinput" value="<?php echo $secb2{'prjct_typ'}?>" >
                    </div>
                    <div class="form-group col-md-4 col-sm-4">
                      <label>c) Date of sanction</label>
                      <input type="text" readonly class="span2 form-control dvRelinput" name="date_of_sanction" value="<?php echo $secb2{'date_of_sanction'}?>" id="dp8" placeholder="dd-mm-yyyy" pattern="\d{1,2}/\d{1,2}/\d{4}">
                    </div>
                    <div class="form-group col-md-4 col-sm-4">
                      <label>d) Amount (Rs. in Crore)</label>
                      <input type="number" readonly name="amount" class="form-control dvRelinput" value="<?php echo $secb2{'amount'}?>" >
                    </div>
                    <div class="form-group col-md-4 col-sm-4">
                      <label>e) Loan amount outstanding (Rs. in Crore)</label>
                      <input type="number" readonly name="loan_amount_outstanding" class="form-control dvRelinput" value="<?php echo $secb2{'loan_amount_outstanding'}?>" >
                    </div>
                  </div>
                </div>
              </div>
			   ...
			   <?php $i=0; foreach($secb2a as $data){  ?>
                ...
                <div class="directordiv test1_<?=$i?>">
                  <div class="form-group col-md-6 col-sm-6">
                    ...
                    <input class="form-control" name="fullName[]" value="<?=$data->fullName ?>" type="text" readonly required>
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Date of Birth</label>
                    <div class="attach">
                      <input type="text" readonly name="birthDate[]" value="<?=$data->birthDate ?>" class="span2 form-control" id="dp9" placeholder="dd-mm-yyyy" pattern="\d{1,2}/\d{1,2}/\d{4}" required>
				...
				<?php } ?>
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Age</label>
                    <input class="form-control" name="age[]" value="<?=$data->age ?>" type="number" readonly required>
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Address</label>
                    <div class="attach">
                      <input class="form-control" name="address[]" value="<?=$data->address ?>"" type="text" readonly required>
				...
				<?php } ?>
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    ...
                    <input class="form-control" name="qualification[]" value="<?=$data->qualification ?>"" type="text" readonly required>
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                    <label>PAN Number</label>
                    <div class="attach">
                      <input class="form-control" name="pannumber[]" value="<?=$data->pannumber ?>"" type="text" readonly required>
				...
				<?php } ?>
				   ...
				   <div class="form-group col-md-6 col-sm-6">
                    ...
                    <input class="form-control" name="din_number[]" value="<?=$data->din_number ?>"" type="text" readonly required>
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Experience in power and other sectors</label>
                    <input class="form-control" name="experience_power[]" value="<?=$data->experience_power ?>"" type="text" readonly required>
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Nature</label>
                    <input class="form-control" name="nature[]" value="<?=$data->nature ?>"" type="text" readonly placeholder="Promoter/Independent/Professional/family member, etc." required>
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Shareholding in the Company (%)</label>
                    <input class="form-control"  name="shareHolding[]" value="<?=$data->shareHolding ?>" type="number" readonly required>
                  </div>
                  <div class="form-group col-md-11">
                    ...
                    <input class="form-control" name="name_of_company[]" value="<?=$data->name_of_company ?>" " type="text" readonly required>
                  </div>
				  <?php if($i>0){?>
          ...
          <div class="form-group col-md-12">
            ...
            <div class="attach">
              <input class="form-control" name="promoter_certified_by_company_secretary" type="text" readonly value = "<?php echo $secb2['promoter_certified_by_company_secretary'] ?>" required>
          ...
          <div class="form-group col-md-12">
            ...
            <input class="form-control" type="text" readonly name="market_200_day_moving_avg_52_week_high_low" value = "<?php echo $secb2['market_200_day_moving_avg_52_week_high_low'] ?>" required>
          </div>
          <div class="form-group col-md-12">
            <label>21) Details of shares pledged, if any, of the promoters of the promoting company</label>
            <div class="attach">
              <input class="form-control" type="text" readonly name="detail_pledged_pormoting_company" value = "<?php echo $secb2['detail_pledged_pormoting_company'] ?>" required>
          ...
          <div class="form-group col-md-12">
            ...
            <div class="attach">
              <input class="form-control" name="shrholdng_pattrn_4_yr_state_prmotr_nonprmotr" type="text" readonly value = "<?php echo $secb2['shrholdng_pattrn_4_yr_state_prmotr_nonprmotr'] ?>" required>
          ...
          <div class="form-group col-md-12">
            ...
            <div class="attach">
              <input class="form-control" type="text" readonly name="sttory_adt_certificate_cash_loss" value = "<?php echo $secb2['sttory_adt_certificate_cash_loss'] ?>" required>
              ...
              <div class="form-group col-md-12">
                ...
                <div class="">
                  ...
                  <label for="chkNcredit1" class="radio-inline">
                    ...
                    No </label>
                  <div class="attach pull-right" id="dvCredit1" style="display: <?php if($secb2['chkCredit1']=="yes" || $secb2['chkCredit1'] == ""){echo "block" ;}else{echo "none";}?>"> 
              ...
              <div class="form-group col-md-12">
                ...
                <div class="">
                  ...
                  <label for="chkNcredit1" class="radio-inline">
                    ...
                    No </label>
                  <div class="attach pull-right" id="dvCredit2" style="display: <?php if($secb2['chkCredit2']=="yes"){echo "block" ;}else{echo "none";}?>"> 
          ...
          <div class="form-group col-md-12">
            ...
            <div class="">
              ...
              <label for="chkNprodetails" class="radio-inline">
                ...
                No </label>
              <div class="attach pull-right" id="dvProdetails" style="display: <?php if($secb2['chkProdetails']=="yes"){echo "block" ;}else{echo "none";}?>"> 
          ...
          <div class="form-group col-md-12">
            ...
            <div class="">
              ...
              <label for="chkNannualreport" class="radio-inline">
                ...
                No </label>
              <div class="attach pull-right" id="dvAnnualreport" style="display: <?php if($secb2['chkAnnualreport']=="yes"){echo "block" ;}else{echo "none";}?>"> 
              ...
              <div class="form-group col-md-12">
                ...
                <div class="">
                  ...
                  <label for="chkNfundsinfo" class="radio-inline">
                    ...
                    No </label>
                  <div class="attach pull-right" id="dvFundsinfo" style="display: <?php if($secb3['chkFundsinfo']=="yes"){echo "block" ;}else{echo "none";}?>">  
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" rows="5" id="" name="cash_internal_accruals_prposd_used" required ><?php print_r($secb3['cash_internal_accruals_prposd_used']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" rows="5" id="" name="plnning_to_raise_debt_your_book_acount_bringng_equty_ratio" required ><?php print_r($secb3['plnning_to_raise_debt_your_book_acount_bringng_equty_ratio']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" rows="5" id="" name="marketable_securities_going_used_fr_fndng_equty_requirmnt" required ><?php print_r($secb3['marketable_securities_going_used_fr_fndng_equty_requirmnt']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                <label>e) Any other source of raising funds for equity investment in the project.</label>
                 
                <textarea readonly  class="form-control" rows="5" id="" name="source_raising_funds_equity_investment" required ><?php print_r($secb3['source_raising_funds_equity_investment']); ?></textarea>
              ...
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" rows="5" id="" name="statmnt_of_clculatn_cash_flow_fr_invstmnt_prposd_prject" required ><?php print_r($secb3['statmnt_of_clculatn_cash_flow_fr_invstmnt_prposd_prject']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="text" readonly class="form-control" name="critical_factors_affecting_business_segment" value="<?php print_r($secb4['critical_factors_affecting_business_segment'])?>" required>
              </div>
              <div class="form-group col-md-12">
                <label>d) Management view for key developments, risks, challenges, opportunities in each business segment</label>
                <input type="text" readonly class="form-control" name="key_developments_risks_challenges_opportunities_business_segment" value="<?php print_r($secb4['key_developments_risks_challenges_opportunities_business_segment'])?>" required>
              </div>
              <div class="">
                <div class="">
                  <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <div class="">
                      ...
                      <label for="chkNforeign" class="radio-inline">
                        ...
                        No </label>
                      <div class="attach pull-right" id="dvForeign" style="display: <?php if($secb4['chkForeign']=="yes"){echo "blocl" ;}else{echo "none"; }?>">  
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea readonly  class="form-control" rows="5" id="" name="foreign_currency_exposure_durng_pst_4_yr_profit_loss" required ><?php print_r($secb4['foreign_currency_exposure_durng_pst_4_yr_profit_loss'])?></textarea>
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" rows="5" id="" name="sundry_debtors_and_sundry_creditors_contitutng_last_audtd_yr" required ><?php print_r($secb4['sundry_debtors_and_sundry_creditors_contitutng_last_audtd_yr'])?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="form-group col-md-12">
                ...
                <div class="">
                  ...
                  <div id="dvChangeposition" style="display: <?php if($secb5['chkChangeposition'] == "yes"){echo "block"; }else{echo "none"; } ?> ">
                    <textarea readonly class="form-control" rows="5" id="txtChangeposition" name="positn_change_contingnt_liabilites_last_blance_sheet" <?php if($secb5['chkChangeposition'] == "yes"){echo "required"; }?>><?php print_r($secb5['positn_change_contingnt_liabilites_last_blance_sheet']); ?></textarea>
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12">
                <label>g) Any significant changes affecting position of accounts contained in latest Annual Report</label>
                <textarea readonly class="form-control" rows="5" id="" name="accounts_contained_latest_annual_report" required><?php print_r($secb5['accounts_contained_latest_annual_report']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" rows="5" id="" name="updates_on_litigations_contained_anuual_report" required><?php print_r($secb5['updates_on_litigations_contained_anuual_report']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" rows="5" id="" name="off_balance_sheet_items" required ><?php print_r($secb5['off_balance_sheet_items']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                <label>k) Reasons for interest accrued and due, if any.</label>
                <textarea readonly  class="form-control" rows="5" id="" name="reasons_for_interest_accrued" required ><?php print_r($secb5['reasons_for_interest_accrued']); ?></textarea>
              </div>
            </div>
          </div>
          <div class="col-md-12">
        ...
        <div class="row setup-content" id="step-6">
          ...
          <div class="form-group col-md-12">
            ...
            <textarea readonly  class="form-control" rows="5" id="" name="name_and_address_of_the_main_bankers_having_business_deal" required ><?php print_r($secb6['name_and_address_of_the_main_bankers_having_business_deal']); ?></textarea>
          </div>
          <div class="form-group col-md-12">
            <label>33) Changes in shareholding and management in past 4 years.</label>
            <input class="form-control" type="text" readonly name="change_shareholding_and_management" value="<?php print_r($secb6['change_shareholding_and_management']); ?>" required>
          </div>
          <div class="form-group col-md-12">
          ...
          <div class="form-group col-md-12">
            ...
            <div class="">
              ...
              <div class="attach" id="dvCharges" style="display: <?php if($secb6['chkCharges'] == "yes"){echo "block" ;}else{echo "none" ; }  ?> ">
                <input type="text" readonly class="form-control" id="txtCharges" name = "loan_syndication_consultant_along_appointment" value="<?php print_r($secb6['loan_syndication_consultant_along_appointment']); ?>" <?php if($secb6['chkCharges'] == "yes"){echo "required" ;}?> >
          ...
          <div class="form-group col-md-12">
            ...
            <textarea readonly  class="form-control" rows="5" id="" name="due_diligence_report" required ><?php print_r($secb6['due_diligence_report']); ?></textarea>
          </div>
          <div class="form-group col-md-12">
            <label>39) List /Undertaking for Litigations for the each Promoter Company, duly signed and stamped by the authorized person:-</label>
              ...
              <label for="chkYAClitigation" class="radio-inline">
                <input type="radio" id="chkYAClitigation" name="chkAClitigation" value="Yes" onclick="ShowHideAClitigation()" <?php if($secb6['chkAClitigation'] == "Yes"){ echo "checked"; }?> >
                Yes </label>
              <label for="chkNAClitigation" class="radio-inline">
                <input type="radio" id="chkNAClitigation" name="chkAClitigation" value="No" onclick="ShowHideAClitigation()" <?php if($secb6['chkAClitigation'] == "No"){ echo "checked"; }?> >
                No </label>
              <br>
              <br>
              <div class="" id="dvAClitigation" style="display: <?php if($secb6['chkAClitigation'] == "Yes"){echo "block"; }else{ echo "none"; }?>;">
                <textarea type="text" readonly class="form-control" id="txtAClitigation" name="undrtking_litigatn_for_each_prmotr" ><?php print_r ($secb6['undrtking_litigatn_for_each_prmotr']); ?></textarea>
                </div>
    ...
    In case of any litigation with respect to above, complete details of the case/matter, the last hearing date, next hearing date and status may be furnished.</p>
          ...
          <div class="form-group col-md-12">
            ...
            <textarea readonly  class="form-control" rows="5" id="" name="undertake_financing_of_project" required ><?php print_r($secb6['undertake_financing_of_project']); ?></textarea>
          </div>
        ...
        <div class="row setup-content" id="step-7">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="form-group col-md-4 col-sm-4">
                <label>1) Name</label>
                <input type="text" readonly class="form-control" name="indvduls_contrbutng_eqty_name" value="<?php print_r($secb7['indvduls_contrbutng_eqty_name']); ?>" required >
              </div>
              <div class="form-group col-md-4 col-sm-4">
                <label>2) PAN</label>
                <div class="attach">
                  <input type="text" readonly class="form-control" name="pannumber" value="<?php print_r($secb7['pannumber']); ?>" required >
              ...
              <div class="form-group col-md-4 col-sm-4">
                ...
                <div class="attach">
                  <input type="text" readonly class="span2 form-control" name="date_of_birth" value="<?php print_r($secb7['date_of_birth']); ?>" id="dp10" placeholder="dd-mm-yyyy" pattern="\d{1,2}/\d{1,2}/\d{4}" required >
              ...
              <div class="form-group col-md-12">
                ...
                <div class="attach">
                  <input type="text" readonly class="form-control" id="cadd" name="curnt_address" placeholder="Current Address" value="<?php print_r($secb7['curnt_address']); ?>" required >
                ...
                <br>
                <div class="attach">
                  <input type="text" readonly name="prmnt_address" id="padd" class="form-control" placeholder="Permanent Address" value="<?php if($secb7['same_as'] ==  "same") { print_r($secb7['curnt_address']); }else{ print_r($secb7['prmnt_address']); } ?>">
              ...
              <div class="form-group col-md-6 col-sm-6">
                ...
                <input type="number" readonly class="form-control" name="telphne_no" value="<?php print_r($secb7['telphne_no']); ?>" required>
              </div>
              <div class="form-group col-md-6 col-sm-6">
                <label>6) Net worth statement duly certified by Chartered Accountant </label>
                <div class="attach">
                  <input type="text" readonly class="form-control" name="worth_statmnt_duly_crtifid_acountnt" value="<?php print_r($secb7['worth_statmnt_duly_crtifid_acountnt']); ?>" required>
              ...
              <div class="form-group col-md-6 col-sm-6">
                ...
                <div class="attach"> 
                  <input type="text" readonly class="form-control" name="wlth_tax_statmnt_crtifid_acountnt" value="<?php print_r($secb7['wlth_tax_statmnt_crtifid_acountnt']); ?>" required >
              ...
              <div class="form-group col-md-6 col-sm-6">
                ...
                <div class="attach">
                  <input type="text" readonly class="form-control" name="incmetax_asesmnt_ordr" value="<?php print_r($secb7['incmetax_asesmnt_ordr']); ?>" required >
              ...
              <div class="form-group col-md-6 col-sm-6">
                ...
                <div class="attach">
                  <input type="text" readonly class="form-control" name="income_tax_return_past_3_yr" value="<?php print_r($secb7['income_tax_return_past_3_yr']); ?>" required >
              ...
              <div class="">
                <div class="">
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    ...
                    <input type="text" readonly class="form-control" name="individuals_promoter" value="<?php print_r($secb7['individuals_promoter']); ?>" required >
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                    <label>b) With other corporate promoters, if any.</label>
                    <input type="text" readonly class="form-control"  name="corporate_promoter" value="<?php print_r($secb7['corporate_promoter']); ?>" required >
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12">
                <label>11) Whether Indian /Foreign National (please give name of the country)/NRI</label>
                <input type="text" readonly class="form-control" name="wethr_indian_foreign_nationl" value="<?php print_r($secb7['wethr_indian_foreign_nationl']); ?>" required >
              ...
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" rows="5" id="" name="seling_real_estate_inclding_agrcltral_land_shares" required ><?php print_r($secb7['seling_real_estate_inclding_agrcltral_land_shares']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                <label>13) Note on existing business operations, if any</label>
                <textarea readonly  class="form-control" rows="5" id="comment" name="exstng_busines_oprtions" required ><?php print_r($secb7['exstng_busines_oprtions']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                <label>14) Note on promoters‟ qualifications/experience in managing/operating businesses</label>
                <textarea readonly  class="form-control" rows="5" id="comment" name="prmtrs_qulifctions_exprnce_in_mngng_busines" required ><?php print_r($secb7['prmtrs_qulifctions_exprnce_in_mngng_busines']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                <label>15) Details of current over dues, if any, to any bank/FI</label>
                <textarea readonly  class="form-control" name="dtls_of_curent_over_dues" rows="5" id="comment" required ><?php print_r($secb7['dtls_of_curent_over_dues']); ?>	</textarea>
              </div>
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" name="rcovry_cdr_pckge_restrctring_reschdlng" rows="5" id="comment" required ><?php print_r($secb7['rcovry_cdr_pckge_restrctring_reschdlng']); ?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="">
                <div class="">
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    ...
                    <input type="text" readonly class="form-control" name="corpus_fund_schm_makng_invstmnt" value="<?php print_r($secb8['corpus_fund_schm_makng_invstmnt']); ?>" required >
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                    <label>b) Registered office address</label>
                    <div class="attach">
                      <input type="text" readonly class="form-control" name="registrd_offce_addrs" value="<?php print_r($secb8['registrd_offce_addrs']); ?>" required >
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    ...
                    <div class="attach">
                      <input type="text" readonly class="form-control" name="communicating_office_address" value="<?php print_r($secb8['communicating_office_address']); ?>" required >
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    ...
                    <input type="url" readonly class="form-control" name="corpus_fund_website_address" value="<?php print_r($secb8['corpus_fund_website_address']); ?>" required>
                  </div>
				   <div class="form-group col-md-6 col-sm-6">
                    <label>f) Key Managerial Personnel</label>
                    <input type="text" readonly class="form-control" name="managerial_personnel" value="<?php print_r($secb8['managerial_personnel']); ?>" required>
                  </div>
                </div>
              </div>
              <div class="form-group col-md-6 col-sm-6">
              ...
              <div class="form-group col-md-6 col-sm-6">
                ...
                <input type="text" readonly class="form-control" name="size_corpus_fnd_schm_mkng_invstmnt" value="<?php print_r($secb8['size_corpus_fnd_schm_mkng_invstmnt']); ?>" required>
              </div>
              <div class="form-group col-md-12">
                ...
                <div class="">
                  ...
                  <label for="chkNcreditrating" class="radio-inline">
                    ...
                    No </label>
                  <div class="attach pull-right" id="dvCreditrating" style="display: <?php if($secb8['chkCreditrating'] == "yes" ){echo "block"; }else{echo "none"; }?>"> 
              ...
              <div class="form-group col-md-12">
                ...
                <div class="">
                  ...
                  <br>
                    ...
                    <textarea readonly  class="form-control" rows="5" id="" name="whthr_trm_shet_elaborate" placeholder="please elaborate..." ><?php print_r($secb8['whthr_trm_shet_elaborate']); ?></textarea>
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12">
                <label>6) Note on equity subscription pattern and arrangements for phasing of equity</label>
                <textarea readonly  class="form-control" name="sbscrptn_patrn_and_arangmnts_phsng_eqty" rows="5" id="" required ><?php print_r($secb8['sbscrptn_patrn_and_arangmnts_phsng_eqty']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" name="trm_shet_agremnt_prvde_buy_bck_asurd_rtrn_oblgtns_cmpny" rows="5" id="" required ><?php print_r($secb8['trm_shet_agremnt_prvde_buy_bck_asurd_rtrn_oblgtns_cmpny']); ?></textarea>
              </div>
              <div class="">
                <div class="">
                  <div class="col-md-12">
                  ...
                  <div class="form-group col-md-4 col-sm-4">
                    ...
                    <input type="text" readonly class="form-control" name="fund_intr_alia_mngmnt" value="<?php print_r($secb8['fund_intr_alia_mngmnt']); ?>" required >
                  </div>
                  <div class="form-group col-md-4 col-sm-4">
                    <label>b) Board of Trustees</label>
                    <input type="text" readonly class="form-control" name="fund_intr_alia_bord_of_trshs" value="<?php print_r($secb8['fund_intr_alia_bord_of_trshs']); ?>" required >
                  </div>
                  <div class="form-group col-md-4 col-sm-4">
                    <label>c) Investment Committee</label>
                    <input type="text" readonly class="form-control" name="fund_intr_alia_invstmnt_cmite" value="<?php print_r($secb8['fund_intr_alia_invstmnt_cmite']); ?>" required >
                  </div>
                  <div class="form-group col-md-4 col-sm-4">
                    <label>d) Sector Exposures</label>
                    <input type="text" readonly class="form-control" name="fund_intr_alia_sctr_expsre" value="<?php print_r($secb8['fund_intr_alia_sctr_expsre']); ?>" required >
                  </div>
                  <div class="form-group col-md-4 col-sm-4">
                    <label>e) Country exposures</label>
                    <input type="text" readonly class="form-control" name="fund_intr_alia_cntry_expsre" value="<?php print_r($secb8['fund_intr_alia_cntry_expsre']); ?>" required >
                  </div>
                  <div class="form-group col-md-4 col-sm-4">
                    <label>f). Key management Evalation</label>
                    <input type="text" readonly class="form-control" name="key_managment_evalation" value="<?php print_r($secb8['key_managment_evalation']); ?>" required >
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12">
                <label>9) Registration status with Regulatory bodies in India (viz. RBI, SEBI, etc.) or abroad (specify)</label>
                <textarea readonly  class="form-control" name="rgstrtn_sts_with_regltry_bodes_in_india" rows="5" id="" required ><?php print_r($secb8['rgstrtn_sts_with_regltry_bodes_in_india']); ?></textarea>
              </div>
              <div class="form-group col-md-6 col-sm-6">
              ...
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" name="applicable_regulatory_framework" rows="5" id="" required ><?php print_r($secb8['applicable_regulatory_framework']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" name="prpsd_invstd_durng_curncy_debt_frm_bnks_fis_planning" rows="5" id="" required ><?php print_r($secb8['prpsd_invstd_durng_curncy_debt_frm_bnks_fis_planning']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
                ...
                <textarea readonly  class="form-control" name="whthr_eqty_invstmnt_prpsd_mde_dcrtly_cmpny" rows="5" id="" required ><?php print_r($secb8['whthr_eqty_invstmnt_prpsd_mde_dcrtly_cmpny']); ?></textarea>
              </div>
            </div>
          </div>
       ...
       <div class="row setup-content" id="step-9">
              ...
              <div class="">
                <div class="">
                  <div class="form-group col-md-12">
                    ...
                    <textarea readonly  class="form-control" name="banks_fis_brief_dtls" rows="5" id="" required><?php print_r($secb9['banks_fis_brief_dtls']); ?></textarea>
                  </div>
                  <div class="form-group col-md-12">
                    <label>2) Assets size (i.e. Advances + Investments)</label>
                    <textarea readonly  class="form-control" name="banks_fis_asets_sze_advncd_invstmnts" rows="5" id="" required><?php print_r($secb9['banks_fis_asets_sze_advncd_invstmnts']); ?></textarea>
                  </div>
                  <div class="form-group col-md-12">
                    <label>3) Is it intended that they will exercise management control</label>
                    <textarea readonly  class="form-control" name="banks_fis_intnded_that_exrsze_mngmnt_cntrl" rows="5" id="" required><?php print_r($secb9['banks_fis_intnded_that_exrsze_mngmnt_cntrl']); ?></textarea>
                  </div>
                  <div class="">
                    <div class="">
                      <div class="radiosection">
                        ...
                        <div class="form-group">
                          ...
                          <div id="dvRbicertificate" class="" style="display: <?php if($secb9['chkRbicertificate'] == "yes") {echo "block"; }else{echo "none;"; } ?>;">
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                              ...
                              <input type="text" readonly class="form-control" name="whethr_clasfied_rbi_crtfcate_no" value="<?php print_r($secb9['whethr_clasfied_rbi_crtfcate_no']); ?>" >
                            </div>
                            <div class="form-group col-md-4 col-sm-4">
                              <label>Date</label>
                              <input type="text" readonly class="span2 form-control"  pattern="\d{1,2}/\d{1,2}/\d{4}" name="whethr_clasfied_rbi_date" value="<?php print_r($secb9['whethr_clasfied_rbi_date']); ?>" id="dp11" placeholder="dd-mm-yyyy" >
                            </div>
                            <div class="form-group col-md-4 col-sm-4">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea readonly  class="form-control" name="dtls_as_per_abve_extnt_aplicble" rows="5" id="" required><?php print_r($secb9['dtls_as_per_abve_extnt_aplicble']); ?></textarea>
                  </div>
                </div>
              </div>
            </div>
		...
		<div class="row setup-content" id="step-10">
              ...
              <div class="">
                <div class="">
                  <div class="form-group col-md-4 col-sm-4">
                    ...
                    <input type="text" readonly class="form-control" name="nbfcs_new_ownd_funfs" value="<?php print_r($secb10['nbfcs_new_ownd_funfs']); ?>" required>
                  </div>
                  <div class="form-group col-md-4 col-sm-4">
                    <label>2) Track record of Profits for past three years</label>
                    <input type="text" readonly class="form-control" name="nbfcs_track_recrd_prfts_pst_three_yrs" value="<?php print_r($secb10['nbfcs_track_recrd_prfts_pst_three_yrs']); ?>" required>
                  </div>
                  <div class="form-group col-md-4 col-sm-4">
                    ...
                    <div class="">
                      ...
                      <label for="chkNcreditrating1" class="radio-inline">
                        ...
                        No </label>
                      <div class="attach pull-right" id="dvCreditrating1" style="display: <?php if($secb10['chkCreditrating1'] == "yes"){echo "block"; }else{echo "none"; }?>"> 
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea readonly  class="form-control" name="dtls_as_per_b_abve_extnt_aplicble" rows="5" id="" required><?php print_r($secb10['dtls_as_per_b_abve_extnt_aplicble']); ?></textarea>
                  </div>
                </div>
              </div>
			   <div class="">
                <div class="">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea readonly  class="form-control" name="nature_of_eqty_suprt_arngmnts_phsng_eqty" rows="5" id="" required><?php print_r($secb10['nature_of_eqty_suprt_arngmnts_phsng_eqty']); ?></textarea>
                  </div>
                  <div class="form-group col-md-12">
                    <label>3) Status/Stage of actual allotment of equity shares</label>
                    <input type="text" readonly class="form-control" name="status_stge_alotmnt_of_eqty_shrs" value="<?php print_r($secb10['status_stge_alotmnt_of_eqty_shrs']); ?>" required>
                  </div>
                </div>
             </div>
            </div>
          ...
          <div class="col-md-12 text-right">
			...
			<button type="button" class="btn print  btn-primary">Print</button>
				<a href="<?php echo base_url();?>wp-admin/users/form2_next_step3/<?php echo $this->uri->segment('4');?>" class="agree btn btn-primary">Save & Go to Section B Part 2</a> 
			</div>
               <!--<button type="submit" class="btn nextBtn  btn-primary">Save & Next</button>-->
          </div>
