          ...
          <div class="clearfix"></div>
            ...
            <div class="col-md-12">
              <div class="pull-right">
				...
				<a href="<?php echo base_url();?>wp-admin/users/form2_next_step2/<?php echo $this->uri->segment('4');?>" class="agree btn btn-primary">Save & Next</a> 
			</div>
					
			  <!--<button class="agree btn btn-primary" type="submit" id="chkybutton" disabled="">Submit</button> -->
