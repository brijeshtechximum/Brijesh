    ...
    <div class="container">
      <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
          <div class="stepwizard-step steps step-1"> <a href="#step-1" id="idsecc1" type="button" class="btn btn-primary btn-circle">1</a>
            <p>Step 1</p>
          </div>
          <div class="stepwizard-step steps step-2"> <a href="#step-2" id="idsecc2" type="button" class="btn btn-default btn-circle" disabled="disabled">2</a>
            <p>Step 2</p>
          </div>
          <div class="stepwizard-step steps step-3"> <a href="#step-3" id="idsecc3" type="button" class="btn btn-default btn-circle" disabled="disabled">3</a>
            <p>Step 3</p>
          </div>
          <div class="stepwizard-step steps step-4"> <a href="#step-4" id="idsecc4" type="button" class="btn btn-default btn-circle" disabled="disabled">4</a>
            <p>Step 4</p>
          </div>
          <div class="stepwizard-step steps step-5"> <a href="#step-5" id="idsecc5" type="button" class="btn btn-default btn-circle" disabled="disabled">5</a>
            <p>Step 5</p>
          </div>
        </div>
      </div>
    ...
    <div class="container">
	  ...
	  <!------------------------step-1-------------------->
        ...
        <div class="row setup-content" id="step-1">
          ...
          <form role="form" action="<?php echo base_url(); ?>form2/sectionc1/step-1" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>1.</strong> Can the Core Promoters management be considered to be broad-based?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="core_prmtrs_mngmnt_broad_based_optnl_atchmnt_file" >
                  </span> 
              ...
              <div class="">
                <div class="">
				  ...
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['respect_of_directors_name'])) { echo  $this->session->flashdata('step1')['respect_of_directors_name']; } ?></span></div>
                    <label>i) Name</label>
                    <input type="text" class="form-control" name="respect_of_directors_name" value="<?php print($sec_c1['respect_of_directors_name']); ?>" required>
                  </div>
                  <div class="form-group col-md-4">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['respect_of_directors_age'])) { echo  $this->session->flashdata('step1')['respect_of_directors_age']; } ?></span></div>
                    <label>ii) Age</label>
                    <input type="number" class="form-control" name="respect_of_directors_age" value="<?php print($sec_c1['respect_of_directors_age']); ?>" required>
                  </div>
                  <div class="form-group col-md-4">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['respect_of_directors_address'])) { echo  $this->session->flashdata('step1')['respect_of_directors_address']; } ?></span></div>
                    <label>iii) Address</label>
                    <input type="text" class="form-control" name="respect_of_directors_address" value="<?php print($sec_c1['respect_of_directors_address']); ?>" required>
                  </div>
                  <div class="form-group col-md-4">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['respect_of_directors_qualification'])) { echo  $this->session->flashdata('step1')['respect_of_directors_qualification']; } ?></span></div>
                    <label>iv) Qualification</label>
                    <input type="text" class="form-control" name="respect_of_directors_qualification" value="<?php print($sec_c1['respect_of_directors_qualification']); ?>" required>
                  </div>
                  <div class="form-group col-md-4">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['respect_of_directors_pan'])) { echo  $this->session->flashdata('step1')['respect_of_directors_pan']; } ?></span></div>
                    <label>v) PAN</label>
                    <input type="text" class="form-control" pattern="[a-zA-z]{5}\d{4}[a-zA-Z]{1}" name="respect_of_directors_pan" value="<?php print($sec_c1['respect_of_directors_pan']); ?>" required>
                  </div>
                  <div class="form-group col-md-4">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['respect_of_directors_din'])) { echo  $this->session->flashdata('step1')['respect_of_directors_din']; } ?></span></div>
                    <label>vi) DIN</label>
                    <input type="text" class="form-control" name="respect_of_directors_din" value="<?php print($sec_c1['respect_of_directors_din']); ?>" required>
                  </div>
                </div>
              </div>
              <div class="form-group col-md-4">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['total_exprnce_pwr_sctr'])) { echo  $this->session->flashdata('step1')['total_exprnce_pwr_sctr']; } ?></span></div>
                <label>b) Total Experience in power sector</label>
                <input type="text" class="form-control" name="total_exprnce_pwr_sctr" value="<?php print($sec_c1['total_exprnce_pwr_sctr']); ?>" required>
              </div>
              <div class="form-group col-md-4">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['total_exprnce_othr_sctr'])) { echo  $this->session->flashdata('step1')['total_exprnce_othr_sctr']; } ?></span></div>
                <label>c) Total Experience in other sectors</label>
                <input type="text" class="form-control" name="total_exprnce_othr_sctr" value="<?php print($sec_c1['total_exprnce_othr_sctr']); ?>" required>
              </div>
              <div class="form-group col-md-4">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['core_prmtrs_nature'])) { echo  $this->session->flashdata('step1')['core_prmtrs_nature']; } ?></span></div>
                <label>d) Nature</label>
                <input type="text" class="form-control" name="core_prmtrs_nature" value="<?php print($sec_c1['core_prmtrs_nature']); ?>" placeholder="Promoter/Independent/Professional/Family member etc" required>
              </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>2.</strong> Do the Core Promoters employ qualified, experienced and professional management personnel?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="emply_qulifed_exprnc_mngmnt_optnl_atchmnt_file" >
                  </span> 
			  ...
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['relvnt_qulfcton_senr_mngmnt_prtflio'])) { echo  $this->session->flashdata('step1')['relvnt_qulfcton_senr_mngmnt_prtflio']; } ?></span></div>
                <label>a) Relevant Qualification of the senior management relevant to the portfolio / work being handled</label>
                <textarea required  class="form-control" rows="5" name="relvnt_qulfcton_senr_mngmnt_prtflio" ><?php print($sec_c1['relvnt_qulfcton_senr_mngmnt_prtflio']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['total_exprnce_senior_mngmnt'])) { echo  $this->session->flashdata('step1')['total_exprnce_senior_mngmnt']; } ?></span></div>
                <label>b) Total experience of the senior management.</label>
                <textarea required  class="form-control" rows="5" name="total_exprnce_senior_mngmnt" ><?php print($sec_c1['total_exprnce_senior_mngmnt']); ?></textarea>
              </div>
              <div class="form-group col-md-12">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['rlvnt_senr_mngmnt_curent_prtflio_handled'])) { echo  $this->session->flashdata('step1')['rlvnt_senr_mngmnt_curent_prtflio_handled']; } ?></span></div>
                <label>c) Relevant experience of the senior management relevant to the current portfolio / work being handled</label>
                <textarea required  class="form-control" rows="5" name="rlvnt_senr_mngmnt_curent_prtflio_handled" ><?php print($sec_c1['rlvnt_senr_mngmnt_curent_prtflio_handled']); ?></textarea>
              </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>3.</strong> Do the Core Promoters have generally efficient systems and procedures?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="genraly_eficient_systms_prcedurs_optnl_atchmnt_file" >
                  </span> 
              ...
              <div class="form-group col-md-12">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['timely_closng_finalztion_acounts'])) { echo  $this->session->flashdata('step1')['timely_closng_finalztion_acounts']; } ?></span></div>
                <label>a) Timely closing and finalization of books of accounts - Date of signing of Balance Sheet for the past 3 years</label>
                <textarea required  class="form-control" rows="5" name="timely_closng_finalztion_acounts"><?php print($sec_c1['timely_closng_finalztion_acounts']); ?></textarea>
              </div>
              <div class="">
                <div class="">
                  <div class="col-md-12">
				  ...
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['prtnrs_total_nmbrs_qualfed_cas'])) { echo  $this->session->flashdata('step1')['prtnrs_total_nmbrs_qualfed_cas']; } ?></span></div>
                    <label>i) Partners and total number of qualified CAs</label>
                    <input type="text" class="form-control" name="prtnrs_total_nmbrs_qualfed_cas" value="<?php print($sec_c1['prtnrs_total_nmbrs_qualfed_cas']); ?>" required>
                  </div>
                  <div class="form-group col-md-6">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['major_audts_othr_cmpny'])) { echo  $this->session->flashdata('step1')['major_audts_othr_cmpny']; } ?></span></div>
                    <label>ii) Major audits of other companies</label>
                    <input type="text" class="form-control" name="major_audts_othr_cmpny" value="<?php print($sec_c1['major_audts_othr_cmpny']); ?>" required>
                  </div>
                  <div class="form-group col-md-12">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['statry_audtrs_and_intrnl_audtrs'])) { echo  $this->session->flashdata('step1')['statry_audtrs_and_intrnl_audtrs']; } ?></span></div>
                    <label>iii) Companies in Promoter group being audited by Statutory Auditor/Internal Auditor</label>
                    <input type="text" class="form-control" name="statry_audtrs_and_intrnl_audtrs" value="<?php print($sec_c1['statry_audtrs_and_intrnl_audtrs']); ?>" required>
                  </div>
                </div>
              </div>
              <div class="">
                <div class="">
                  ...
                  <div class="form-group col-md-12">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['presnce_indpndnt_intrnl_audt_dvsion'])) { echo  $this->session->flashdata('step1')['presnce_indpndnt_intrnl_audt_dvsion']; } ?></span></div>
                    <label>i) Presence of in house or independent Internal Audit Team/Division</label>
                    <input type="text" class="form-control" name="presnce_indpndnt_intrnl_audt_dvsion" value="<?php print($sec_c1['presnce_indpndnt_intrnl_audt_dvsion']); ?>" required>
                  </div>
                  <div class="form-group col-md-12">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['constution_audt_comite_sctn_292'])) { echo  $this->session->flashdata('step1')['constution_audt_comite_sctn_292']; } ?></span></div>
                    <label>ii) Constitution of Audit Committee in consonance of Section 292 A of Companies Act 1956, </label>
                    <input type="text" class="form-control" name="constution_audt_comite_sctn_292" value="<?php print($sec_c1['constution_audt_comite_sctn_292']); ?>" required>
                  </div>
                  <div class="form-group col-md-12">
                      
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['dtls_qulty_certfction_dasign_indpndnt_agncy'])) { echo  $this->session->flashdata('step1')['dtls_qulty_certfction_dasign_indpndnt_agncy']; } ?></span></div>
                      
                    <label>iii) Details of quality certifications (i.e. ISO etc.) assigned to the company by Independent agencies, if any</label>
                    <textarea required  class="form-control" rows="5" name="dtls_qulty_certfction_dasign_indpndnt_agncy" ><?php print($sec_c1['dtls_qulty_certfction_dasign_indpndnt_agncy']); ?></textarea>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
			  ...
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step1')['dmnstrte_ablty_infrstrutre_indstrl_othr_prjcts'])) { echo  $this->session->flashdata('step1')['dmnstrte_ablty_infrstrutre_indstrl_othr_prjcts']; } ?></span></div>
				  <input type="text" class="form-control" name="dmnstrte_ablty_infrstrutre_indstrl_othr_prjcts" value="<?php print($sec_c1['dmnstrte_ablty_infrstrutre_indstrl_othr_prjcts']); ?>"  placeholder="" aria-describedby="basic-addon2" required>
				  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="dmnstrte_ablty_infrstrutre_indstrl_othr_prjcts_file"  >
                  </span> 
                ...
                <div class="">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="attach"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                      <input type="file" accept="application/pdf, application/zip"    name="simlr_dtls_core_prmtrs_statry_audtr_certfcate_file" >
                      </span> 
		...
		<form  role="form" action="<?php echo base_url(); ?>form2/sectionc2/step-2" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>5.</strong> Is the size of the Core Promoters existing operations comparable to their expansion plans?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="core_prmtrs_exstng_oprtions_expnsn_plns_optnl_certfcte_file" >
                  </span> 
              ...
              <div class="">
                <div class="">
                  ...
                  <div class=" form-group col-md-12">
					...
					<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step2')['exstng_new_aggrgte_brf_infrmtion'])) { echo  $this->session->flashdata('step2')['exstng_new_aggrgte_brf_infrmtion']; } ?></span></div>
                    <textarea required  class="form-control" name="exstng_new_aggrgte_brf_infrmtion" rows="5" placeholder="Breif note..." ><?php print($sec_c2['exstng_new_aggrgte_brf_infrmtion']); ?></textarea>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>6.</strong> Do the Core Promoters deploy conservative debt gearing levels to pursue their business plans?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="deploy_cnsrvtve_debt_optnl_atchmnt_file">
                  </span> 
				...
				<?php } ?>
                  ...
                  <div class=" form-group col-md-12">
				  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step2')['provide_exstng_debt_eqty_ratio_expnsn_pln'])) { echo  $this->session->flashdata('step2')['provide_exstng_debt_eqty_ratio_expnsn_pln']; } ?></span></div>
                    ...
                    <textarea required  class="form-control" rows="5" name="provide_exstng_debt_eqty_ratio_expnsn_pln" ><?php print($sec_c2['provide_exstng_debt_eqty_ratio_expnsn_pln']); ?></textarea>
                  </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>7.</strong> Are the expansion plans of the Core Promoter reasonable and stable in nature?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="resnble_stble_nature_optnl_atchment_file" >
                  </span> 
              ...
              <div class="">
                <div class="">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class=" form-group col-md-12">
					<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step2')['complxty_and_stablty_of_thr_sctr'])) { echo  $this->session->flashdata('step2')['complxty_and_stablty_of_thr_sctr']; } ?></span></div>
                    ...
                    <textarea required  class="form-control" rows="5" name="complxty_and_stablty_of_thr_sctr" ><?php print($sec_c2['complxty_and_stablty_of_thr_sctr']); ?></textarea>
                  </div>
                    <div class=" form-group col-md-12">
					<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step2')['simlrty_of_the_curnt_oprtion'])) { echo  $this->session->flashdata('step2')['simlrty_of_the_curnt_oprtion']; } ?></span></div>
                    <label>b) The similarity of the expansion with the current operations and</label>
                    <textarea required  class="form-control" rows="5" name="simlrty_of_the_curnt_oprtion" ><?php print($sec_c2['simlrty_of_the_curnt_oprtion']); ?></textarea>
                  </div>
                    <div class=" form-group col-md-12">
					<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step2')['ablty_mngmnt_rlted_unrlted_expnsn'])) { echo  $this->session->flashdata('step2')['ablty_mngmnt_rlted_unrlted_expnsn']; } ?></span></div>
                    <label>c) The ability of the management of the company to take up such related / unrelated expansions in the past</label>
                    <textarea required  class="form-control" rows="5" name="ablty_mngmnt_rlted_unrlted_expnsn" ><?php print($sec_c2['ablty_mngmnt_rlted_unrlted_expnsn']); ?></textarea>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>8.</strong> Do the Core Promoters have the policy of hedging foreign currency exposure?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="polcy_hedgng_forgn_curncy_optnl_certfcte_file" >
                  </span> 
              ...
              <div class="">
                <div class="">
                  ...
                  <h6>Please provide the following details:</h6>
                    ...
                    <div class=" form-group col-md-12">
					<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step2')['busness_expsd_forign_exchnge_flctutions'])) { echo  $this->session->flashdata('step2')['busness_expsd_forign_exchnge_flctutions']; } ?></span></div>
                    ...
                    <textarea required  class="form-control" rows="5" name="busness_expsd_forign_exchnge_flctutions" ><?php print($sec_c2['busness_expsd_forign_exchnge_flctutions']); ?></textarea>
                  </div>
                    <div class=" form-group col-md-12">
					<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step2')['writn_polcy_aprvd_bod_hedgng_dlng'])) { echo  $this->session->flashdata('step2')['writn_polcy_aprvd_bod_hedgng_dlng']; } ?></span></div>
                    ...
                    <textarea required  class="form-control" rows="5" name="writn_polcy_aprvd_bod_hedgng_dlng" ><?php print($sec_c2['writn_polcy_aprvd_bod_hedgng_dlng']); ?></textarea>
                  </div>
                    <div class=" form-group col-md-12">
					<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step2')['whther_forign_exchnge_trnsctions_aprvd_plcy_guidelne'])) { echo  $this->session->flashdata('step2')['whther_forign_exchnge_trnsctions_aprvd_plcy_guidelne']; } ?></span></div>
                    <label>c) Whether the foreign exchange transactions are treated as per the approved policy guidelines</label>
                    <textarea required  class="form-control" rows="5" name="whther_forign_exchnge_trnsctions_aprvd_plcy_guidelne" ><?php print($sec_c2['whther_forign_exchnge_trnsctions_aprvd_plcy_guidelne']); ?></textarea>
                  </div>
                </div>
              </div>
		...
		<form role="form" action="<?php echo base_url(); ?>form2/sectionc3/step-3" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>9.</strong> Do the Core Promoters have any experience in the power sector?
                <div class="attach pull-right"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"   name="exprnce_prjct_pwr_sctr_optnl_atchmnt_file" >
                  </span> 
              ...
              <div class="">
                <div class="">
                  ...
                  <div class=" form-group col-md-12">
					...
					<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step3')['respect_of_mngng_cmpltng_gnrtion_trnsmsion_dstrbtion'])) { echo  $this->session->flashdata('step3')['respect_of_mngng_cmpltng_gnrtion_trnsmsion_dstrbtion']; } ?></span></div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step3')['devlped_oprtd_per_cmprble_prpsd_prjct'])) { echo  $this->session->flashdata('step3')['devlped_oprtd_per_cmprble_prpsd_prjct']; } ?></span></div>
				  <input type="text" class="form-control" name="devlped_oprtd_per_cmprble_prpsd_prjct" value="<?php print($sec_c3['devlped_oprtd_per_cmprble_prpsd_prjct']); ?>" placeholder="" aria-describedby="basic-addon2" required>
				  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="devlped_oprtd_per_cmprble_prpsd_prjct_file" >
                  </span> 
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step3')['exprnce_devlpng_oprtng_epc_srvcs_mnfctriing'])) { echo  $this->session->flashdata('step3')['exprnce_devlpng_oprtng_epc_srvcs_mnfctriing']; } ?></span></div>
			  <input type="text" class="form-control" name="exprnce_devlpng_oprtng_epc_srvcs_mnfctriing" value="<?php print($sec_c3['exprnce_devlpng_oprtng_epc_srvcs_mnfctriing'])?>" aria-describedby="basic-addon2" required>
			  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="exprnce_devlpng_oprtng_epc_srvcs_mnfctriing_file">
                  </span> 
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step3')['pwr_oprtng_capcties_top_domstc_plyrs'])) { echo  $this->session->flashdata('step3')['pwr_oprtng_capcties_top_domstc_plyrs']; } ?></span></div>
			  <input type="text" class="form-control" name="pwr_oprtng_capcties_top_domstc_plyrs" value="<?php print($sec_c3['pwr_oprtng_capcties_top_domstc_plyrs'])?>" aria-describedby="basic-addon2" required>
			  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="pwr_oprtng_capcties_top_domstc_plyrs_file" >
                  </span> 
		...
		<form role="form" action="<?php echo base_url(); ?>form2/sectionc4/step-4" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="sub-part">
              <div class="attachheading h4font"><strong>13.</strong> Have the Core Promoters developed any project of <u>similar nature</u> in the past?
               ...
               <div class="input-group col-md-3 pull-right">
			   <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step4')['core_prmtrs_prjct_simlr_natre'])) { echo  $this->session->flashdata('step4')['core_prmtrs_prjct_simlr_natre']; } ?></span></div>
  <input required type="text" class="form-control" name="core_prmtrs_prjct_simlr_natre" value="<?php print($sec_c4['core_prmtrs_prjct_simlr_natre']); ?>" aria-describedby="basic-addon2">
  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="core_prmtrs_prjct_simlr_natre_file" >
                  </span> 
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step4')['infrstrcture_prjct_simlr_size'])) { echo  $this->session->flashdata('step4')['infrstrcture_prjct_simlr_size']; } ?></span></div>
  <input required type="text" class="form-control" name="infrstrcture_prjct_simlr_size" value="<?php print($sec_c4['infrstrcture_prjct_simlr_size']);?>" aria-describedby="basic-addon2">
  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="infrstrcture_prjct_simlr_size_file" >
                  </span> 
...
<div class="clearfix"></div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step4')['setup__mnged_indstrial_size_prjct'])) { echo  $this->session->flashdata('step4')['setup__mnged_indstrial_size_prjct']; } ?></span></div>
  <input required type="text" class="form-control" name="setup__mnged_indstrial_size_prjct" value="<?php print($sec_c4['setup__mnged_indstrial_size_prjct']); ?>" aria-describedby="basic-addon2">
  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="setup__mnged_indstrial_size_prjct_file" >
                  </span> 
...
<div class="clearfix"></div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step4')['providng_epc_srvces_indstrial_or_indstrial_prjcts'])) { echo  $this->session->flashdata('step4')['providng_epc_srvces_indstrial_or_indstrial_prjcts']; } ?></span></div>
  <input required type="text" class="form-control" name="providng_epc_srvces_indstrial_or_indstrial_prjcts" value="<?php print($sec_c4['providng_epc_srvces_indstrial_or_indstrial_prjcts']); ?>" aria-describedby="basic-addon2">
  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="providng_epc_srvces_indstrial_or_indstrial_prjcts_file" >
                  </span> 
...
<div class="clearfix"></div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step4')['manged_busines_devlpng_ecnomies'])) { echo  $this->session->flashdata('step4')['manged_busines_devlpng_ecnomies']; } ?></span></div>
  <input required type="text" class="form-control" name="manged_busines_devlpng_ecnomies" value="<?php print($sec_c4['manged_busines_devlpng_ecnomies']); ?>" aria-describedby="basic-addon2">
  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="manged_busines_devlpng_ecnomies_file" >
                  </span> 
...
<div class="clearfix"></div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step4')['prior_expirnce_dlng_gov_authrty_india'])) { echo  $this->session->flashdata('step4')['prior_expirnce_dlng_gov_authrty_india']; } ?></span></div>
  <input required type="text" class="form-control" name="prior_expirnce_dlng_gov_authrty_india" value="<?php print($sec_c4['prior_expirnce_dlng_gov_authrty_india']); ?>" aria-describedby="basic-addon2">
  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="prior_expirnce_dlng_gov_authrty_india_file" >
                  </span> 
...
<div class="clearfix"></div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step4')['acquiring_land_clernce_india'])) { echo  $this->session->flashdata('step4')['acquiring_land_clernce_india']; } ?></span></div>
  <input required type="text" class="form-control" name="acquiring_land_clernce_india"  value="<?php print($sec_c4['acquiring_land_clernce_india']);?>" aria-describedby="basic-addon2">
  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="acquiring_land_clernce_india_file" >
                  </span> 
...
<div class="clearfix"></div>
          ...
          <div class="col-md-12">
            <div class="sub-part">
              ...
              <div class="input-group col-md-3 pull-right">
			  <div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step4')['successfully_devlpng_simlr_prjcts_ecnomies'])) { echo  $this->session->flashdata('step4')['successfully_devlpng_simlr_prjcts_ecnomies']; } ?></span></div>
  <input required type="text" class="form-control" name="successfully_devlpng_simlr_prjcts_ecnomies" value="<?php print($sec_c4['successfully_devlpng_simlr_prjcts_ecnomies']); ?>" aria-describedby="basic-addon2">
  <div class="attach input-group-addon"> <span class="btn btn-primary btn-file"> <span><i class="fa fa-paperclip" aria-hidden="true"></i></span>
                  <input type="file" accept="application/pdf, application/zip"    name="successfully_devlpng_simlr_prjcts_ecnomies_file" >
                  </span> 
...
<div class="clearfix"></div>
        ...
        <div class="row setup-content" id="step-5">
		  ...
		  <form role="form" action="<?php echo base_url(); ?>form2/process_generation_success" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <div class="col-md-12">
				<div class="has-error"><span class="help-block"><?php if(isset($this->session->flashdata('step5')['agree'])) { echo  $this->session->flashdata('step5')['agree']; } ?></span></div>
                <div class="checkbox">
				 <input type="checkbox" name="agree" value="agree" id="chky" <?php if($sec_c4['agree'] == "agree"){echo "checked";}?>/>
                  <label>
            ...
            <div class="col-md-12">
				<button class="btn btn-default prevBtn pull-left" type="button">Previous</button>
              <div class="pull-right"> <button type="submit" class="agree btn btn-primary" id="chkybutton" <?php if(!$sec_c4['agree'] == "agree"){echo "disabled";}?> >Submit</button> </div>
...
<script>
 $(document).ready(function() {
    ...
    $(document).ready(function(){
        ...
        <?php if(!empty($sec_c1['respect_of_directors_name'])){ ?>
            if (!$('#idsecc1').hasClass('disabled')) {
            $('#idsecc1').addClass('btn-success');
            }
        <?php } ?>
        
         <?php if(!empty($sec_c2['exstng_new_aggrgte_brf_infrmtion'])){ ?>
          
            if (!$('#idsecc2').hasClass('disabled')) {
            $('#idsecc2').addClass('btn-success');
            $('#idsecc2').removeAttr('disabled');
            }
        <?php } ?>
         <?php if(!empty($sec_c3['respect_of_mngng_cmpltng_gnrtion_trnsmsion_dstrbtion'])){ ?>
          
            if (!$('#idsecc3').hasClass('disabled')) {
            $('#idsecc3').addClass('btn-success');
            $('#idsecc3').removeAttr('disabled');
            }
        <?php } ?>
         <?php if(!empty($sec_c4['core_prmtrs_prjct_simlr_natre'])){ ?>
          
            if (!$('#idsecc4').hasClass('disabled')) {
            $('#idsecc4').addClass('btn-success');
            $('#idsecc4').removeAttr('disabled');
            }
        <?php } ?>
         <?php if(!empty($sec_c4['place'])){ ?>
          
            if (!$('#idsecc5').hasClass('disabled')) {
            $('#idsecc5').addClass('btn-success');
            $('#idsecc5').removeAttr('disabled');
            }
        <?php } ?>
