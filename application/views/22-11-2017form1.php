...
<?php if($gn_2['licenses_approval_forest_land_evacuation']=='Yes'){echo 'checked'; $lafle = 'block';}else{$lafle = 'none';}?>
 />
          ...
          <div class="row setup-content" id="step-4">
			...
			<?php pr($this->session->flashdata('step4'));?>
            <div class="col-md-12">
              <div class="sub-part">
                ...
                <div class="col-md-12">
                  <div class="sub-part">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input required="" type="text" class="form-control" id="dp37" name="schdl_cod" value="<?php print($rn_2['schdl_cod']); ?>">
                    </div>
                    <div class="form-group col-md-3">
		...
		<div class="loan-form">
          ...
          <div class="row setup-content" id="state-1">
                ...
                <div class="form-group col-md-12">
				  ...
				  <option value="Awarded"<?php if($state_sector_b['tendering_status'] == "Awarded") { echo "selected"; } ?>>Awarded</option>
                    ...
                    <div class="form-group col-md-4">
					  ...
					  <select class="form-control" name="state_sector_b[proj_implementation_period]">
					  <option> Select </option>
                    ...
                    <div class="form-group col-md-4">
					  ...
					  <select class="form-control" name="state_sector_b[escrow_cover_availability]" >
					   <option>Select </option>
                    ...
                    <div class="form-group col-md-4">
					  ...
					  <select class="form-control" name="state_sector_b[loan_repayment_period_req]">
					  <option> Select </option>
					 ...
					 <div class="form-group col-md-4">
					  ...
					  <select class="form-control" name="state_sector_b[moratorium]">
					  <option> Select </option>
                ...
                <div class="form-group col-md-12">
                  <div class="sub-part">
                    ...
                    <div class="col-md-4">
					  ...
					  <select class="form-control" name="state_sector_c[audit_ac_status]">
					  <?php 
							$date=11;
                    ...
                    <h6>10) Regulatory Status</h6>
					  ...
					  <select class="form-control" name="state_sector_c[tariff_petition]">
					  <option>Select</option>
					  <?php 
							$date=11;
                    ...
                    <div class="form-group col-md-4">
                     ...
                     <!-- <input required="" type="text" class="form-control" name="state_sector_c[default_status]" value="<?php print($state_sector_c['default_status'])?>">-->
					  <select class="form-control" name="state_sector_c[default_status]">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <!--<input required="" type="text" class="form-control" name="state_sector_c[entity_grade]" value="<?php print($state_sector_c['entity_grade'])?>" >-->
					   ...
					   <select class="form-control" name="state_sector_c[entity_grade]">
					   <option>Select</option>
            ...
            <div class="col-md-12 text-right">
              ...
              <button class="btn btn-primary" type="submit" id="sub" disabled >Save & Next</button>
            </div>
			</form>
          </div>
...
<script>
	...
	$(document).ready(function(){
		...
		<?php if($form_show=='statesectorthings'){ ?>
			$(".mainselection").toggle();
			$(".statesectorthings").toggle();
			$(".hideinstruction").toggle();
			//$(".state_sector_1").attr('disabled','disabled');
