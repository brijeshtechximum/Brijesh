...
Dropzone.options.myDropzone = {
	...
	init: function() {
	  ...
	  this.on("success", function(file,responseText) {
		...
		is_image_primary = Dropzone.createElement('<input class="tags-input form-control" type="text" name="description[]" placeholder="Enter your Title" style="border:1px solid;">');
